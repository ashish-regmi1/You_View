...
const Video = () => {
  return (
    <Container>
      <Content>
        <VideoWrapper>
          <iframe width="853" height="480" src="https://www.youtube.com/embed/GrlAInfP990?list=RDGrlAInfP990" title="Sajjan Raj Vaidya - Chitthi Bhitra [Official Release]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

        </VideoWrapper>
        <Title>Test Video</Title>
        <Details>
          <Info>5m views . Aug 28 2003</Info>
          <Buttons>
            <Button>Like</Button>
